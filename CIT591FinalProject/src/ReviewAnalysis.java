...
public class ReviewAnalysis {
    ...
    // this is the threshold we are using to determine Positive, Negative, and
    // Neutral review.
    ...
    /**
     * This method will return the array list of reviews with most popular (the one
     * with most reviews) item.
     *
     * @return ArrayList of Reviews associated with Clothing ID that has the most
     *         reviews.
     */
    ...
    /**
     * This method will return a hashmap of number of reviews for each department
     * 
     * @param reviews
     * @return a HashMap<String, Integer> DepartmentToNumOfReviews
     * 
     */
